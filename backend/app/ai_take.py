...
SYSTEM_PROMPT = (
    ...
    "Given the structured facts below, write 2-3 sentences a rep could say out loud on a call "
    "with the customer's champion, or paste into an internal Slack thread to their manager. "
    "Be specific and grounded in the numbers given — do not invent facts, competitors, or figures "
